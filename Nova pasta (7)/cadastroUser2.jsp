            ...
            <div class="col-lg-6 col-md-8 col-sm-10">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <% } %>
                        <form name="frmContato" action="cadastroUsuario" method="post" onsubmit="return validar()">
                            <div class="mb-3">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="comunicacao-whatsapp">Aceito receber comunicações nossa por WhatsApp.</label>
                            </div>
                            ...
                            <button type="button" class="btn btn-secondary w-100 mt-2" onclick="history.back()">Voltar</button>
                        </form>
                    </div>
                </div>
            </div>
